        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/news" className="text-sm text-gray-400 hover:text-white transition-colors">News</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li className="text-sm text-gray-400">info@hawa.id</li>
              <li className="text-sm text-gray-400">Bandung, Indonesia</li>
