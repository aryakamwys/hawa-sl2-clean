        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <Image src="/logo.png" alt="HAWA" width={28} height={28} />
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li className="text-sm text-blue-50">Bandung, Indonesia</li>
              <li className="flex gap-4 mt-3">
                <a href="#" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white transition-colors">
                ...
                <a href="https://medium.com/@hawaairinfo" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white transition-colors">
